    ...
    stages {
        ...
        stage('deploy') {
            input {
                ...
                ok 'Yes'
                parameters {
                    choice(name: 'ONE', choices: ['DEV', 'STAGING', 'PROD'], description: 'Which environment would you like to deploy to?')
                    choice(name: 'TWO', choices: ['DEV', 'STAGING', 'PROD'], description: 'Which environment would you like to deploy to?')
                }
